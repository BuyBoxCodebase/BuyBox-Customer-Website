...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Pin to top-right, with a little spacing from the edges
      "fixed top-4 right-4 z-[100] flex max-h-screen flex-col space-y-2 p-4 md:max-w-[420px]",
      className
    )}
    {...props}
  />
